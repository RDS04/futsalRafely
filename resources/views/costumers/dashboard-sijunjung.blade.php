...
<div class="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-8">
            <h1 class="text-3xl font-bold text-white">Dashboard Member - Sijunjung</h1>
        ...
        <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6">
            ...
            <p class="text-white/70 mb-4">Region: <span class="font-semibold text-green-400">{{ Auth::user()->region }}</span></p>
            ...
            <div class="mt-6 bg-green-500/10 border border-green-400/20 rounded-lg p-4">
