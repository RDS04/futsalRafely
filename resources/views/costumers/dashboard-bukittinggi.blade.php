...
<div class="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-8">
            <h1 class="text-3xl font-bold text-white">Dashboard Member - Bukittinggi</h1>
        ...
        <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6">
            ...
            <p class="text-white/70 mb-4">Region: <span class="font-semibold text-purple-400">{{ Auth::user()->region }}</span></p>
            
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                <div class="bg-purple-500/20 border border-purple-400/30 rounded-lg p-4">
                    <h3 class="text-white font-semibold mb-2">EmailCostumer</h3>
            ...
            <div class="mt-6 bg-purple-500/10 border border-purple-400/20 rounded-lg p-4">
